<div id="search-container">
	{{Form::open(['url'=>route('search-market-motorcycle'),'method'=>'get','id'=>'market-search-form','class'=>' ','novalidate'=>true])}}
		<div class="row">
			...
			<div class="col-sm-6 col-lg-4 ">
				<div class="form-group">
					{{Form::select('type',['Svi tipovi']+[1=>'Street','Cafe Racer','Cruiser','Sport','Touring','Scrambler','Off-Road','Moped'],$keywords['type']??null, ['class' => 'input-data select-info form-control'])}}
				</div>
			</div>
			<div class="col-sm-6 col-lg-4 ">
