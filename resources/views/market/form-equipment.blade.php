{{Form::open(['url'=>route('market-store-equipment'),'files' => true,'id'=>'market-create-form','class'=>'','novalidate'=>true])}}
	<div class="row">
	...
	{{Form::submit('Postavi', ['id'=>'submit-btn','class' => 'btn btn-primary','type'=>'submit','disabled'=>'disabled'])}}
{{Form::close()}}