{{Form::open(['url'=>route('market-store-truck'),'files' => true,'id'=>'market-create-form','class'=>'','novalidate'=>true])}}
	...
	<div class="row">
		<div id="brand-container" class="col-sm-6 col-lg-3 ">
			<div class="form-group">
				...
				{{Form::select('brand',[],null,['id'=>'brand','class'=>'input-data select-info vehicle-brand form-control'])}}
				<div class="error-msg"></div>
			</div>
	...
	<div class="row">
		<div class="col-sm-6 col-lg-3">
			<div class="form-group">
				...
				{{Form::select('type', [1=>'Kamion', 'Kombi', 'Autobus', 'Kamper'], [], ['class' => 'input-data select-info form-control'])}}
				<div class="error-msg"></div>
			</div>
		</div>
		<div class="col-sm-6 col-lg-3 ">
	...
	<div class="row">
		<div class="col-sm-6 col-lg-3 ">
			<div class="form-group">
				...
				{{Form::select('axle', [1=>2,3,4,5,6], [], ['class'=>'input-data select-info form-control'])}}
				<div class="error-msg"></div>
			</div>
		</div>
		<div class="col-sm-6 col-lg-3 ">
