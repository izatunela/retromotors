...
<div class="market-edit-wrap">
	{{ Form::model($item, ['route' => ['market-automobile-update','id'=> $item->id], 'method' => 'patch','files' => true,'id'=>'market-create-form','class'=>'edit-zone','novalidate'=>true]) }}
		...
		<div class="row">
			...
			<div id="model-container" class="col-sm-6 col-lg-3">
				<div id="automobile-model-select" class="form-group">
					{{Form::label('model', 'Model vozila',['class' => ''])}}
					{{Form::select('model',$models,$item->model->name,['id'=>'model','class' => 'input-data select-info form-control'])}}
					<div class="error-msg"></div>
				</div>
				<div id="custom-model" class="form-group">
					{{Form::label('custom_model', 'Model vozila',['class' => ''])}}
					{{Form::text('custom_model',$item->customBrandModel->model??null,['id'=>'','class'=>'input-data input-info form-control','placeholder'=>'Unesite model'])}}
					<div class="error-msg"></div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-6 col-lg-3">
				<div class="form-group">
					...
					{{Form::select('type', [1=>'Limuzina','Hatchback','Kupe','Karavan','Kabriolet','SUV','Pickup'], $item->type_id, ['class' => 'input-data select-info form-control'])}}
					<div class="error-msg"></div>
				</div>
			</div>
			<div class="col-sm-6 col-lg-3">
		...
		<div class="row">
			<div class="col-sm-6 col-lg-3">
				<div class="form-group">
					...
					{{Form::select('drivetrain', [1 => 'Prednji','Zadnji','4x4'],$item->drivetrain_id, ['class' => 'input-data select-info  form-control'])}}
					<div class="error-msg"></div>
				</div>
			</div>
			<div class="col-sm-6 col-lg-3">
...
@endsection
@section('content-js')
	<script src="{{asset('js/market/edit-automobile.js')}}"></script>
@endsection