	...
	<div class="row">
		<div class="col-sm-6 col-lg-3">
			<div class="form-group">
				...
				{{Form::select('color', [1=>'Bela','Bež','Bordo','Braon','Crna','Crvena','Narandžasta','Plava','Siva','Srebrna','Tirkiz','Teget','Zelena','Zlatna','Žuta'], [], ['class' => 'input-data select-info form-control'])}}
				<div class="error-msg"></div>
			</div>
		</div>
		<div class="col-sm-6 col-lg-3">
