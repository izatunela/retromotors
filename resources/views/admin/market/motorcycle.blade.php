			...
			<table class="footable table table-stripped toggle-arrow-tiny" data-filter=#filter>
				...
				<tr>
					...
					<td>
						...
						<button class="btn custom-button model-delete" type="button" data-category="motorcycle" data-model-id="{{$item->id}}"><i class="icon-red fas fa-times"></i> Delete</button>
					</td>
				</tr>
				@endforeach
				</tbody>
				...
				<tr>
					...
					<td>
						@if(!$item->user()->withTrashed()->first()->deleted_at)
							<button class="btn custom-button model-restore" type="button" data-category="motorcycle" data-model-id="{{$item->id}}">
