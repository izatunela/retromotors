	...
	<div id="ajax-content">
			...
			<div class="ibox-content wew">
				...
				<table class="footable table table-stripped toggle-arrow-tiny" data-filter=#filter>
					...
					<tr>
						...
						<th>Prodavac</th>
						<th data-hide="phone,tablet">Proizvodjač</th>
					...
					<tr>
						...
						<td>
							...
							<button class="btn custom-button model-delete" type="button" data-category="automobile" data-model-id="{{$item->id}}"><i class="icon-red fas fa-times"></i> Delete</button>
						</td>
					</tr>
					@endforeach
					</tbody>
		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				<table id="kita" class="footable table table-stripped toggle-arrow-tiny" data-filter=#filter-del>
					<thead>
					<tr>
						<th data-toggle="true">Naziv</th>
						<th data-type="numeric">Cena</th>
					...
					<tr class="izbrisani">
						...
						<td>
							@if(!$item->user()->withTrashed()->first()->deleted_at)
								<button class="btn custom-button model-restore" type="button" data-category="automobile" data-model-id="{{$item->id}}">
